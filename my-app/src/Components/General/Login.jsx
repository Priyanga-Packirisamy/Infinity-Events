...
const Login = () => {
  ...
  const handleLoginSubmit = (e) => {
    ...
    login(loginForm).then((res) => {
      if (res?.data?.accessToken) {
          ...
          navigate((jwtDecode(res?.data?.accessToken).role === 'USER') ? '/orghome' : '/home');
      }
  ...
  return (
    <form onSubmit={handleLoginSubmit}>
      <div className="h-[100vh] items-center flex justify-center px-5 pl-4 pr-24">
        <div className=" ml-20 bg-white border shadow sm:rounded-lg flex justify-center flex-1 ">
          <div className="flex-1 bg-blue-200 text-center hidden md:flex">
          <div
        ...
        style={{
          backgroundImage: `url('https://www.tailwindtap.com/assets/components/form/createaccount/login.svg')`,
            ...
            <div className="w-100 p-8 lg:w-1/2">
