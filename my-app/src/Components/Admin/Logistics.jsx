    ...
    <div>
        ...
        <div className='flex'>
            ...
            <div>
                <div>
                    <div className='flex gap-5  bg-gray-200'>
                        ...
                        <div className='flex gap-4 mt-6 mx-20'>
                            <button className='ml-16 text-sm rounded-xl p-3 bg-gray-600 text-white font-semibold hover:bg-gray-700'>ENHANCE YOUR PAGE</button>
                        </div>
                    </div>
                ...
                <div className='bg-gray-100 p-5 pb-16'>
                    <center><div className='pt-3 pb-8 text-lg text-gray-500 font-semibold'>SNAPSHOT SHOWCASE</div></center>
